  ...
  return (
    <div className="rounded-[30px] border border-slate-200 bg-white px-4 py-10 shadow-xl shadow-slate-200/70 md:px-8 md:py-12">
      <h2 className="text-center text-4xl font-black uppercase text-blue-700 md:text-5xl">
        {isVi ? 'Cam kết của Nha Khoa Tận Tâm Smile' : 'Tan Tam Smile Commitments'}
      </h2>
      <p className="mx-auto mt-4 max-w-6xl text-center text-base leading-8 text-slate-700 md:text-lg">
        {isVi
          ? 'Tận Tâm Smile cam kết mang đến nụ cười rạng rỡ và trải nghiệm điều trị chất lượng cao, tận tâm, chuyên nghiệp. Sức khỏe răng miệng của Quý khách là ưu tiên hàng đầu, với dịch vụ vượt trội, an toàn, cùng sự hài lòng tối đa.'
          : 'Tan Tam Smile is committed to delivering excellent dental care with dedication, professionalism, safety, and the highest level of patient satisfaction.'}
      </p>
