...
export function SiteHeader({ onOpenBooking }: SiteHeaderProps) {
  ...
  const topMenuItems: TopMenuItem[] =
    language === 'vi'
      ? [{ label: 'Ưu đãi', isHot: true }, { label: 'Khách hàng' }, { label: 'Liên hệ', hasDropdown: true }]
      : [{ label: 'Promotions', isHot: true }, { label: 'Customers' }, { label: 'Contact', hasDropdown: true }];
        ...
        <div className="flex items-center justify-between border-t border-slate-100 pb-3 pt-2">
          <nav className="flex flex-wrap items-center gap-5">
            ...
            >
              ...
              >
                {text.aboutMenu}
                <span className={`text-sm text-slate-400 transition ${isAboutMenuOpen ? 'rotate-180' : ''}`}>
                  &#9662;
                </span>
              </button>
            ...
            >
              ...
              >
                {text.serviceMenu}
                <span className={`text-sm text-slate-400 transition ${isServiceMenuOpen ? 'rotate-180' : ''}`}>
                  &#9662;
                </span>
              </button>
            ...
            >
              ...
              >
                {text.priceMenu}
                <span className={`text-sm text-slate-400 transition ${isPriceMenuOpen ? 'rotate-180' : ''}`}>
                  &#9662;
                </span>
              </button>
            ...
            >
              ...
              >
                {text.knowledgeMenu}
                <span className={`text-sm text-slate-400 transition ${isKnowledgeMenuOpen ? 'rotate-180' : ''}`}>
                  &#9662;
                </span>
              </button>
